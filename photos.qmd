...
![Snowy Astana, at the entrance to NU off Turan](photos_compressed/astana_snow.jpeg){group="kazakhstan"}

![A real life, running Astana LRT, less than three years after the photo above](photos_compressed/lrt_new_astana.jpeg){group="kazakhstan"}

![Ak Orda and some ducks under stormy skies](photos_compressed/ak_orda_astana.jpeg){group="kazakhstan"}

![Ready for social media](photos_compressed/bayterek_frame.jpeg){group="kazakhstan"}
:::
...
::: {layout-ncol="3"}
![Sprawling Tbilisi, Georgia](photos_compressed/tblisi.jpeg){group="georgia"}

![The TV tower, Tbilisi, Georgia](photos_compressed/tv_tower.jpeg){group="georgia"}

![2004's Holy Trinity Cathedral, Tbilisi, Georgia](photos_compressed/trinity_tblisi.jpeg){group="georgia"}

![Worse-for-wear posters for a candidate from the ruling Georgian Dream, just by party HQ, Tbilisi, Georgia](photos_compressed/georgian_dream.jpeg){group="georgia"}

![A lesser-seen view of the imposing Mother of Georgia, Tbilisi, Georgia](photos_compressed/mother_of_georgia.jpeg){group="georgia"}
...
::: {layout-ncol="3"}
![Memorial to the Armenian Genocide (Tsitsernakaberd), Yerevan](photos_compressed/tsitsernakaberd.jpeg){group="armenia"}

![Mother Armenia, Yerevan](photos_compressed/mother_armenia.jpeg){group="armenia"}

![Geometric flood defences in Areni](photos_compressed/areni_cave.jpeg){group="armenia"}

![Fortress Smbataberd](photos_compressed/smbataberd.jpeg){group="armenia"}

![The Alaverdi copper combine, in decline since independence and recently shut down](photos_compressed/alaverdi.jpeg){group="armenia"}

![In an abandoned Pioneer camp, near Spitak](photos_compressed/spitak_mast.jpeg){group="armenia"}

![The swimming pool at an abandoned Pioneer camp near Spitak](photos_compressed/spitak_pool.jpeg){group="armenia"}

![Sanahin Monastery](photos_compressed/sanahin.jpeg){group="armenia"}
:::