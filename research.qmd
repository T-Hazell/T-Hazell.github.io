...
## Work-in-progress & thesis papers

### Personnel appointments in authoritarian bureaucracies

> **Abstract:** Biased hiring by unelected managers undermines state capacity. Recent work focuses on who gets hired, not the conditions under which it takes place. I argue that, under weak rule of law, bureaucratic managers balance the potential rewards of hiring aligned subordinates with the risk of punishment for breaching civil service regulations. First, biased hiring should be most prominent in the early days of a manager's tenure, when the need to replace unknown staff is most urgent. Second, managers appoint more when they can draw on the protection of a senior patron. Third, unlike political patronage, appointments should be focused on senior roles. Using new data on thousands of district bureaucrat appointments in Kazakhstan---extracted from millions of public procurement contracts---I use two-way fixed effects designs to show that new managers quickly replace subordinates despite civil service regulations, that appointments decline after the departure of their boss, and that there are no equivalent effects for junior staff. The findings highlight how informal politics sustiain biased hiring in autocracies despite civil service reforms.

- Presented at the Department of Political Science and International Relations, Nazarbayev University, Astana
...
> **Abstract:** This study examines whether political decentralization improves local governance in authoritarian settings. We analyze Kazakhstan's 2021 reform introducing direct elections of rural executives, exploiting its staggered and quasi-random rollout across municipalities. Using data on nearly one million procurement contracts and satellite nighttime luminosity data over an eight-year period (2018-2025), we assess the effects of elections on street lighting provision—an objective, locally salient public good. Contrary to accountability theory, elections produced minimal effects, suggesting that political decentralization alone may be insufficient to improve local service delivery without fiscal and administrative decentralization.
